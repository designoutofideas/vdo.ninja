...
This directory contains various examples demonstrating different features and capabilities of Voices. All examples are accessible through the index.html file.
...
- **iframe.outbound-stats.html** - Get stats from Voices using the iframe API
...
- **dual.html** - Two Voices windows (Picture-in-Picture style)
...
### Control Examples
- **obsremote.html** - Remotely control OBS using Voices
...
- Examples may require specific Voices features or permissions
