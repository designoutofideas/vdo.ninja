...
[![Share on Twitter](https://img.shields.io/twitter/url?style=social&url=https%3A%2F%2Fgithub.com%2Fsteveseguin%2Fvdoninja)](https://twitter.com/intent/tweet?text=Check%20out%20Voices%20-%20Peer-to-peer%20video%20streaming%20for%20OBS%20and%20more!&url=https%3A%2F%2Fgithub.com%2Fsteveseguin%2Fvdoninja)

#### ⚠ Notice! We've rebranded from VDO.Ninja to Voices - all else is staying the same ✨


## What is Voices? 🚀

Voices brings peer-to-peer technology to OBS and other studio software, enabling remote camera integration with:
...
You can get started by just opening [Voices](https://vdo.ninja/) in your browser and selecting *Add your Camera to OBS*.
...
## Alternative versions of Voices
...
## What's in this repo
This repo contains the web client software for Voices, along with many sample apps that leverage its IFRAME API. A sample config file and instructions for setting up an optional TURN video relay server is also provided here. The user documentation for Voices itself is found at docs.vdo.ninja.

## How to Deploy this Repo
Voices is available as a free-to-use hosted service at https://vdo.ninja, so deploying is optional. If you do wish to self-deploy the service however, details are provided below.
